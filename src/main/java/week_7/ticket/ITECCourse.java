...
/**
 * Stores data about an ITEC ticket.
 *
 */
public class ITECCourse {
    ...
    public void addStudent(String studentName) {
        ...
        //Check to see if the ticket is full before adding new student
    ...
    public void writeCourseInfo() {
        ...
        System.out.println("The max number of students for this ticket is  " + maxStudents);
    }
