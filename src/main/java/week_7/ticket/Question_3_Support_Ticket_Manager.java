...
Avoids having to make all of the methods in this class static. */
    ...
    protected void deleteTicketById() {
        ...
        int deleteID = intInput("Enter ID of ticket to delete");
    ...
    protected void addTickets() {
        ...
        while (true) {
            ...
            //TODO make sure between 1 and 5
            ...
            String more = stringInput("More tickets to add? Enter N for no, anything else to add more tickets");
