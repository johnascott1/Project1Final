...
public class TicketStore {
    ...
    public LinkedList<Ticket> searchByDescription(String description) {
        ...
        LinkedList<Ticket> matchingTicket = new LinkedList<>();

        for (Ticket ticketThis : ticketQueue) {
            if (ticketThis.getDescription().contains(description)) {
                matchingTicket.add(ticketThis);
